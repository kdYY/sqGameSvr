...
public class ProtoBufUtil {
     ...
     * @param goalBuilder
     * @param sourceBean
     * @param sourceBeanGetMethodMap
     * @param goalBuilderSetMethodMap
     * @param <T>
     * @param <K>
     */
    ...
    /**
     * 获取K中的所有需要执行的方法，排除@TransferProto(ignore=false)的属性, 获取需要注入List的属性 获取function
     */
